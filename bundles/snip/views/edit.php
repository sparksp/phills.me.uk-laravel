...
<?php if($content->id): ?>
	<h1>Edit Snip</h1>
	<?php echo Form::open(URL::to($content->uri()), 'PUT', array('class' => 'snip '.Form::TYPE_HORIZONTAL)); ?>
	<?php $cancel = HTML::link($content->url(), 'Cancel', array('class' => 'btn cancel'))?>
<?php else: ?>
	<h1>Create Snip</h1>
	<?php echo Form::open(URL::to('snips'), 'POST', array('class' => 'snip '.Form::TYPE_HORIZONTAL)); ?>
...
<?php endif; ?>
	...
	<?php echo Form::field('select', 'language', 'Language', array(Snip\Model::language_options(), Input::get('language', $content->language)), array('error' => $errors->first('language'))); ?>
